...
class TLSSnifferApp:
    def __init__(self, master):
        ...
        master.geometry("660x700") # Set initial window size
    ...
    def create_widgets(self):
        ...
        self.status_label.grid(row=2, column=0, columnspan=5, padx=5, pady=5, sticky="w") # Spanning more columns
